...
const HomeDeveloper = ({ getNewCount, title }) => {
  ...
  useEffect(() => {
    title === "Dashboard | OUR LEISURE HOME"
      ...
      : (document.title =
          "Home Developer-WHY DEVELOPER GROUP | OUR LEISURE HOME");
  }, []);
  ...
  const getAllAboutUs = async () => {
    setIsLoaderVisible(true);
      await ApiGet(
        `aboutus/getAllAboutus?page=${page}&limit=${countPerPage}&type=homedeveloper`
      )
        .then((res) => {
        ...
        return (
          <>
            <div className="d-flex justify-content-between">
              ...
              >
                <Tooltip title="Edit Home Page" arrow>
                  <CreateIcon />
                </Tooltip>
              </div>
            </div>
        ...
        <div className="p-2 mb-2">
          <div className="row mb-4 pr-3">
            <div className="col-md-3 col-sm-12 d-flex justify-content-between">
              <h2 className="pl-3 pt-2">Home Developer-WHY DEVELOPER GROUP</h2>
            </div>
            {/* <div className="col-md-7 col-sm-12 mobile-view-align">
              <div>
                <input
                  ...
                  name="title"
                  placeholder="Search Home Developer-WHY DEVELOPER GROUP"
