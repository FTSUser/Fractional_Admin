...
const SuperAdmin = ({ getNewCount, title }) => {
  ...
  const getAllAdmins = async () => {
    ...
    if (!search) {
      await ApiGet(`admin/get-Superadmins?page=${page}&limit=${countPerPage}`)
        .then((res) => {
      ...
      await ApiGet(
        `admin/get-Superadmins?search=${search}&page=${page}&limit=${countPerPage}`
      )
        .then((res) => {
          setIsLoaderVisible(false);
          setFilteredAdmin(res?.data?.payload?.admin);
            ...
            <div className="d-flex justify-content-between cus-medium-button-style">
              <button
                ...
                onClick={() => {
                  ...
                  setStatus(
                    row?.status?.name == "active" ? "inactive" : "active"
                  );
                }}
              >
        ...
        <div className="p-2 mb-2">
          <div className="row mb-4 pr-3">
            <div className="col-md-3 col-sm-12 d-flex justify-content-between">
              <h2 className="pl-3 pt-2">Superadmin Listing</h2>
            </div>
            ...
            <div className="col-md-2 cus-medium-button-style button-height mobile-view-align mobile-button-center-align">
              <button
                onClick={() => {
                  setIsAddAdmin(true);
                  setInputValueForAdd({ role: "61aa037f803e260c3821ad0f" });
                }}
              >
                Add Super Admin
              </button>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              ...
              {status === "active" ? "active" : "inactive"} this superadmin ?
            </Modal.Body>
            <Modal.Footer>
